          ...
          <div className="mt-8 lg:w-1/2 lg:px-6 lg:mt-0">
            ...
            <div className="flex gap-4">
              <Link to="/services-form">
                <button className="px-6 py-2 lg:text-md text-sm text-white bg-purple-500 hover:bg-white hover:text-purple-500 border hover:border-purple-500 duration-200 hover:shadow-xl my-2 rounded-full">
