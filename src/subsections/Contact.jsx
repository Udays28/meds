        ...
        <div className="lg:flex lg:items-center lg:-mx-6">
          <div className="lg:w-1/2 lg:mx-6">
            ...
            <div className="mt-6 w-80 md:mt-8">
              <h3 className="text-gray-600        :text-gray-300 ">
                Follow us
              </h3>
          ...
          <div className="mt-8 lg:w-1/2 lg:mx-6">
            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl        :bg-gray-900 lg:max-w-xl shadow-gray-300/50        :shadow-black/50">
