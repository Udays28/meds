    ...
    <section className="bg-white lg:px-24  :bg-gray-900">
      <div className="container px-6 pt-12 pb-4 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 lg:mt-16 md:grid-cols-2 xl:grid-cols-3">
          <div className="border-2 border-purple-400 p-3 rounded-xl hover:bg-purple-200 duration-150">
            <div className="inline-block p-3 text-white bg-purple-600 rounded-lg">
              <svg
            ...
            <div>
              <h1 className="text-xl font-semibold text-gray-700  :text-white">
                What are the parking and public transport options?
              </h1>
              <p className="mt-2 text-sm text-gray-800  :text-gray-300">
      ...
      <div className="flex justify-center">
        <h1 className=" text-sm bg-purple-200 w-fit px-4 py-2 rounded-full">
          Still have Question?{" "}
          <span className=" cursor-pointer hover:underline text-purple-800 text-md">
            Chat With Us
          </span>
        </h1>
      </div>
